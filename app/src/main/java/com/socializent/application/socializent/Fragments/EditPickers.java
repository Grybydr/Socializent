...
public class EditPickers extends DialogFragment implements DialogInterface.OnCancelListener, DialogInterface.OnDismissListener{
    ...
    private EditEvent callerActivity;
    private int myYear, myMonth, myDay;

    static EditPickers newInstance() {
        return new EditPickers();
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            callerActivity = (EditEvent) getTargetFragment();
        } catch (Exception e) {
            Log.d("EDIT_PICKERS", "Class cast error ");
        }
    }
                ...
                .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if (getTargetFragment() == null) {
                            Log.e("EDIT_PICKERS", "Target Fragment is null!");
                        } else {
                            ...
                            intent.putExtra("EditPickers", myDate);
